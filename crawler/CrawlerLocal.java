...
public class CrawlerLocal {
	...
	public static void main(String args[]) {
		url = "http://ldzl.people.com.cn/dfzlk/front/personProvince3221.htm";// 主要领导-人民网
																			// 地方领导资料库
		file_path = "G:\\本科毕业设计\\简历数据\\网页源代码\\";
		file_no = getFileCount();// 文件编号的起点为当前文件夹中最后一个文件的编号
		regular_expression = "<a href=\"personPage[0-9]+.htm\">";// 观察网页源码可知，其中简历相关的URL都是<a
		// href="personPage....htm">的形式
		...
		for (int i = 0; i < max_thread; i++) {
			new CrawlerLocal().new MyThread().start();
		}
	}
			...
			try {
				...
				for (String line = br.readLine(); line != null; line = br.readLine()) {
					...
					while (m.find()) {
						...
						href = "http://ldzl.people.com.cn/dfzlk/front/" + href;
